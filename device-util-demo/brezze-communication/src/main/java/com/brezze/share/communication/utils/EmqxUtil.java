...
public class EmqxUtil {
    ...
    public static final String BASIC_URL = "https://ub0bc614.ala.dedicated.aws.emqxcloud.com:8443/api/v5";
    public static final String USERNAME = "c2228527c6b07ddd";  // EMQX API Key
    public static final String PASSWORD = "A5Mg-eO4zR8KYtOi1D9o54qR-NmWjbFH";  // EMQX API Secret
    public static final String PRODUCT_KEY = "powerbank";
    public static final String HOST = "ub0bc614.ala.dedicated.aws.emqxcloud.com";
    //以下配置需要定死
    ...
    public static Boolean registerDevice(String host, String username, String password, String deviceName) {
        String url = StrUtil.format("{}/authentication/{}/users",
                BASIC_URL, "password_based:built_in_database");
    ...
    public static Boolean getDeviceInfo(String host, String username, String password, String deviceName) {
        String url = StrUtil.format("{}/authentication/{}/users/{}",
                BASIC_URL, "password_based:built_in_database", deviceName);
        HttpHeaders headers = new HttpHeaders();
        headers.setBasicAuth(username, password);
        try {
    ...
    public static Boolean pubTopicMsg(String host, String username, String password, String productKey, String deviceName, String data) {
        return pubTopicMsg(BASIC_URL, username, password, String.format(TOPIC_GET, productKey, deviceName), data);
    }

    public static Boolean pubTopicMsg(String basicUrl, String username, String password, String topic, String data) {
        String url = StrUtil.format("{}/publish", basicUrl);
        HttpHeaders headers = new HttpHeaders();
        headers.setBasicAuth(username, password);
        headers.setContentType(MediaType.APPLICATION_JSON);
        Map<String, Object> params = new HashMap<>();
